...
slice lands as **one commit per phase** on top of the `6.1.2` fork tag (`1b5585ca9`) — Phase 0
scope & scaffolding, Phase 1 rate-limit core, Phase 2 tests, Phase 3 audit log, Phase 4 docs —
so the phase structure is carried by both these transcripts and the commit history.
