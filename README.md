...
[`ai-artifacts/`](ai-artifacts/); the per-phase notes there map to the per-phase commits in
git history (six commits: Phase 0 split into scope and setup, then core → tests → audit → docs).
